...
interface CheckoutCreatedAndOneCheckoutItemAddedEventProps {
...
export default class CheckoutCreatedAndOneCheckoutItemAddedEvent implements IEvent {
    ...
    constructor(prop: CheckoutCreatedAndOneCheckoutItemAddedEventProps){
