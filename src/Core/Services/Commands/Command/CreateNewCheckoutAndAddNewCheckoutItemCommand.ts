...
interface CreateNewCheckoutAndAddNewCheckoutItemCommandProps {
...
export default class CreateNewCheckoutAndAddNewCheckoutItemCommand implements ICommand {
    ...
    constructor(prop: CreateNewCheckoutAndAddNewCheckoutItemCommandProps){
